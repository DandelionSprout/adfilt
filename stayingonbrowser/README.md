...
The list is designed with Android in mind, and is chiefly tested on uBlock Origin for Firefox Beta Android. However, the list will also have some effect on other browsers (e.g. Adblock Browser) and other portable units (e.g. iOS) as well.
